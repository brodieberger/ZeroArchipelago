...
location_data_table: Dict[str, MMZero3LocationData] = {
    ...
    # Itemsanity:
    "Derelict Spacecraft E-Crystal": MMZero3LocationData(region="Derelict Spacecraft", address=301),
    "Derelict Spacecraft Life Capsule": MMZero3LocationData(region="Derelict Spacecraft", address=302),
    "Aegis Volcano Base E-Crystal (1)": MMZero3LocationData(region="Aegis Volcano Base", address=303),
    "Aegis Volcano Base Life Capsule": MMZero3LocationData(region="Aegis Volcano Base", address=304),
    "Aegis Volcano Base E-Crystal (2)": MMZero3LocationData(region="Aegis Volcano Base", address=305),
    "Aegis Volcano Base E-Crystal (3)": MMZero3LocationData(region="Aegis Volcano Base", address=306),
    "Aegis Volcano Base E-Crystal (4)": MMZero3LocationData(region="Aegis Volcano Base", address=307),
    "Aegis Volcano Base E-Crystal (5)": MMZero3LocationData(region="Aegis Volcano Base", address=308),
    "Aegis Volcano Base E-Crystal (6)": MMZero3LocationData(region="Aegis Volcano Base", address=309),
    "Oceanic Highway Ruins E-Crystal (1)": MMZero3LocationData(region="Oceanic Highway Ruins", address=310),
    "Oceanic Highway Ruins E-Crystal (2)": MMZero3LocationData(region="Oceanic Highway Ruins", address=311),
    "Oceanic Highway Ruins E-Crystal (3)": MMZero3LocationData(region="Oceanic Highway Ruins", address=312),
    "Oceanic Highway Ruins E-Crystal (4)": MMZero3LocationData(region="Oceanic Highway Ruins", address=313),
    "Oceanic Highway Ruins E-Crystal (5)": MMZero3LocationData(region="Oceanic Highway Ruins", address=314),
    "Oceanic Highway Ruins E-Crystal (6)": MMZero3LocationData(region="Oceanic Highway Ruins", address=315),
    "Oceanic Highway Ruins Life Capsule (1)": MMZero3LocationData(region="Oceanic Highway Ruins", address=316),
    "Oceanic Highway Ruins Life Capsule (2)": MMZero3LocationData(region="Oceanic Highway Ruins", address=317),
    "Oceanic Highway Ruins Life Capsule (3)": MMZero3LocationData(region="Oceanic Highway Ruins", address=318),
    "Oceanic Highway Ruins E-Crystal (7)": MMZero3LocationData(region="Oceanic Highway Ruins", address=319),
    "Weapons Repair Factory Life Capsule (1)": MMZero3LocationData(region="Weapons Repair Factory", address=320),
    "Weapons Repair Factory E-Crystal (1)": MMZero3LocationData(region="Weapons Repair Factory", address=321),
    "Weapons Repair Factory E-Crystal (2)": MMZero3LocationData(region="Weapons Repair Factory", address=322),
    "Weapons Repair Factory Life Capsule (2)": MMZero3LocationData(region="Weapons Repair Factory", address=323),
    "Weapons Repair Factory E-Crystal (3)": MMZero3LocationData(region="Weapons Repair Factory", address=324),
    "Weapons Repair Factory E-Crystal (4)": MMZero3LocationData(region="Weapons Repair Factory", address=325),
    "Weapons Repair Factory Life Capsule (3)": MMZero3LocationData(region="Weapons Repair Factory", address=326),
    "Weapons Repair Factory E-Crystal (5)": MMZero3LocationData(region="Weapons Repair Factory", address=327),
    "Weapons Repair Factory E-Crystal (6)": MMZero3LocationData(region="Weapons Repair Factory", address=328),
    "Weapons Repair Factory E-Crystal (7)": MMZero3LocationData(region="Weapons Repair Factory", address=329),
    "Old Residential E-Crystal (1)": MMZero3LocationData(region="Old Residential", address=330),
    "Old Residential Life Capsule (1)": MMZero3LocationData(region="Old Residential", address=331),
    "Old Residential E-Crystal (2)": MMZero3LocationData(region="Old Residential", address=332),
    "Old Residential E-Crystal (3)": MMZero3LocationData(region="Old Residential", address=333),
    "Old Residential E-Crystal (4)": MMZero3LocationData(region="Old Residential", address=334),
    "Old Residential E-Crystal (5)": MMZero3LocationData(region="Old Residential", address=335),
    "Old Residential E-Crystal (6)": MMZero3LocationData(region="Old Residential", address=336),
    "Old Residential Life Capsule (2)": MMZero3LocationData(region="Old Residential", address=337),
    "Old Residential E-Crystal (7)": MMZero3LocationData(region="Old Residential", address=338),
    "Old Residential E-Crystal (8)": MMZero3LocationData(region="Old Residential", address=339),
    "Old Residential Life Capsule (3)": MMZero3LocationData(region="Old Residential", address=340),
    "Old Residential E-Crystal (9)": MMZero3LocationData(region="Old Residential", address=341),
    "Old Residential E-Crystal (10)": MMZero3LocationData(region="Old Residential", address=342),
    "Old Residential E-Crystal (11)": MMZero3LocationData(region="Old Residential", address=343),
    "Old Residential E-Crystal (12)": MMZero3LocationData(region="Old Residential", address=344),
    "Old Residential E-Crystal (13)": MMZero3LocationData(region="Old Residential", address=345),
    "Old Residential Life Capsule (4)": MMZero3LocationData(region="Old Residential", address=346),
    "Old Residential Life Capsule (5)": MMZero3LocationData(region="Old Residential", address=347),
    "Old Residential Life Capsule (6)": MMZero3LocationData(region="Old Residential", address=348),
    "Missile Factory E-Crystal (1)": MMZero3LocationData(region="Missile Factory", address=349),
    "Missile Factory E-Crystal (2)": MMZero3LocationData(region="Missile Factory", address=350),
    "Missile Factory E-Crystal (3)": MMZero3LocationData(region="Missile Factory", address=351),
    "Missile Factory Life Capsule (1)": MMZero3LocationData(region="Missile Factory", address=352),
    "Missile Factory Life Capsule (2)": MMZero3LocationData(region="Missile Factory", address=353),
    "Twilight Desert Life Capsule": MMZero3LocationData(region="Twilight Desert", address=354),
    "Forest of Anatre Life Capsule (1)": MMZero3LocationData(region="Forest of Anatre", address=355),
    "Forest of Anatre Life Capsule (2)": MMZero3LocationData(region="Forest of Anatre", address=356),
    "Forest of Anatre Life Capsule (3)": MMZero3LocationData(region="Forest of Anatre", address=357),
    "Frontline Ice Base Life Capsule": MMZero3LocationData(region="Frontline Ice Base", address=358),
    "Frontline Ice Base E-Crystal (1)": MMZero3LocationData(region="Frontline Ice Base", address=359),
    "Frontline Ice Base E-Crystal (2)": MMZero3LocationData(region="Frontline Ice Base", address=360),
    "Frontline Ice Base E-Crystal (3)": MMZero3LocationData(region="Frontline Ice Base", address=361),
    "Area X-2 Life Capsule (1)": MMZero3LocationData(region="Area X-2", address=362),
    "Area X-2 Life Capsule (2)": MMZero3LocationData(region="Area X-2", address=363),
    "Area X-2 Life Capsule (3)": MMZero3LocationData(region="Area X-2", address=364),
    "Area X-2 Life Capsule (4)": MMZero3LocationData(region="Area X-2", address=365),
    "Energy Facility Life Capsule (1)": MMZero3LocationData(region="Energy Facility", address=366),
    "Energy Facility Life Capsule (2)": MMZero3LocationData(region="Energy Facility", address=367),
    "Energy Facility Life Capsule (3)": MMZero3LocationData(region="Energy Facility", address=368),
    "Energy Facility E-Crystal (1)": MMZero3LocationData(region="Energy Facility", address=369),
    "Energy Facility E-Crystal (2)": MMZero3LocationData(region="Energy Facility", address=370),
    "Energy Facility Life Capsule (4)": MMZero3LocationData(region="Energy Facility", address=371),
    "Sunken Library Life Capsule (1)": MMZero3LocationData(region="Sunken Library", address=372),
    "Sunken Library Life Capsule (2)": MMZero3LocationData(region="Sunken Library", address=373),
    "Sunken Library E-Crystal (1)": MMZero3LocationData(region="Sunken Library", address=374),
    "Sunken Library Life Capsule (3)": MMZero3LocationData(region="Sunken Library", address=375),
    "Sunken Library E-Crystal (2)": MMZero3LocationData(region="Sunken Library", address=376),
    "Sunken Library E-Crystal (3)": MMZero3LocationData(region="Sunken Library", address=377),
    "Giant Elevator E-Crystal (1)": MMZero3LocationData(region="Giant Elevator", address=378),
    "Giant Elevator E-Crystal (2)": MMZero3LocationData(region="Giant Elevator", address=379),
    "Giant Elevator Life Capsule": MMZero3LocationData(region="Giant Elevator", address=380),
    "Sub Arcadia E-Crystal": MMZero3LocationData(region="Sub Arcadia", address=381),
    "Sub Arcadia Life Capsule": MMZero3LocationData(region="Sub Arcadia", address=382),
}
