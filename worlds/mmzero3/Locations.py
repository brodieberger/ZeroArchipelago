...
location_data_table: Dict[str, MMZero3LocationData] = {
    ...
    # Extra Lives
    "Oceanic Highway Ruins 1-UP": MMZero3LocationData(region="Oceanic Highway Ruins", address=231),
    "Old Residential (1) 1-UP": MMZero3LocationData(region="Old Residential", address=232),
    "Old Residential (2) 1-UP": MMZero3LocationData(region="Old Residential", address=233),
    "Missile Factory 1-UP": MMZero3LocationData(region="Missile Factory", address=234),
    "Forest of Anatre 1-UP": MMZero3LocationData(region="Forest of Anatre", address=235),
    "Energy Facility 1-UP": MMZero3LocationData(region="Energy Facility", address=236),
    "Snowy Plains 1-UP": MMZero3LocationData(region="Snowy Plains", address=237),
    "Giant Elevator 1-UP": MMZero3LocationData(region="Giant Elevator", address=238),
    "Sub Arcadia 1-UP": MMZero3LocationData(region="Sub Arcadia", address=239),
    "Resistance Base 1-UP": MMZero3LocationData(region="Resistance Base 1", address=240),
