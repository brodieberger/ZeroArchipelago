...
item_data_table: Dict[str, MMZero3ItemData] = {
    ...
    "Disk 112: Change Nurse Elf Design": MMZero3ItemData(code=112, type=ItemClassification.filler),
    "Disk 113: Reploid to Base Hall": MMZero3ItemData(code=113, type=ItemClassification.filler),
    "Disk 114: Change Alouette Dress Design": MMZero3ItemData(code=114, type=ItemClassification.filler),
    ...
    "Disk 123: Change Animal Elf Design": MMZero3ItemData(code=123, type=ItemClassification.filler),
    ...
    "Disk 129: Right Tower Reploid Added Dialogue": MMZero3ItemData(code=129, type=ItemClassification.filler),
    ...
    "Disk 134: Left Tower Reploid Added Dialogue": MMZero3ItemData(code=134, type=ItemClassification.filler),
    
    "Disk 135: Change Hacker Elf Design": MMZero3ItemData(code=135, type=ItemClassification.filler),
    ...
    # non-bitflags
    "Disk 141: Dialogue Window: Silver": MMZero3ItemData(code=141, type=ItemClassification.filler),
    "Disk 142: Dialogue Window: Blue": MMZero3ItemData(code=142, type=ItemClassification.filler),
    "Disk 143: Dialogue Window: Action": MMZero3ItemData(code=143, type=ItemClassification.filler),
    "Disk 144: Dialogue Window: Mechanical": MMZero3ItemData(code=144, type=ItemClassification.filler),
    "Disk 145: Dialogue Window: Rosebush": MMZero3ItemData(code=145, type=ItemClassification.filler),
    "Disk 146: Dialogue Window: Command Line": MMZero3ItemData(code=146, type=ItemClassification.filler),
    "Disk 147: Dialogue Window: Chains": MMZero3ItemData(code=147, type=ItemClassification.filler),
    "Disk 148: Dialogue Window: Explosion ": MMZero3ItemData(code=148, type=ItemClassification.filler),
    ...
    "Disk 157: Ciel Computer: New": MMZero3ItemData(code=157, type=ItemClassification.filler),
    "Disk 158: Ciel Computer: Vending Machine": MMZero3ItemData(code=158, type=ItemClassification.filler),
    "Disk 159: Ciel Computer: Monument": MMZero3ItemData(code=159, type=ItemClassification.filler),
    "Disk 160: Ciel Computer: Supercomputer": MMZero3ItemData(code=160, type=ItemClassification.filler),
    ...
    "Disk 164: E-Crystals: Green Crystals": MMZero3ItemData(code=164, type=ItemClassification.filler),
    ...
    "Disk 179: Buster Shot: Black Bullets": MMZero3ItemData(code=179, type=ItemClassification.filler),
    "Disk 180: Buster Shot: Nail Bullets": MMZero3ItemData(code=180, type=ItemClassification.filler),
