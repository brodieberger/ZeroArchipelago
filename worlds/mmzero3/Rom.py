...
def cmd_room_talk_tab_select_patch(patch: MMZero3ProcedurePatch) -> None:
    ...
    patch.write_token(
        ...
        0x800000,
        bytes([
        ,
        ]),
    )
    ...
    patch.write_token(
        APTokenTypes.WRITE,
        0xF1066,
        bytes([0x28, 0x1C, 0x00, 0x4B, 0x18, 0x47, 0x8D, 0x00, 0x80, 0x08]),
    )
